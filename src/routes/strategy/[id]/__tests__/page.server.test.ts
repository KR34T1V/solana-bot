...
describe('Strategy ID Page Server', () => {
  ...
  describe('load', () => {
    ...
    it('should handle malformed JSON in version config', async () => {
      const mockStrategy = {
        id: 'strategy-1',
        name: 'Test Strategy',
        type: 'mean_reversion',
    ...
    it('should handle malformed JSON in version performance', async () => {
      const mockStrategy = {
        id: 'strategy-1',
        name: 'Test Strategy',
        type: 'mean_reversion',
        ...
        versions: [{
          ...
          config: '{"param1": "value1"}',
          changes: 'Initial version',
          performance: '{invalid-json}', // Invalid JSON
          backtestResults: null,
          lastTestedAt: null,
          strategyId: 'strategy-1',
          createdAt: new Date()
    ...
    it('should handle malformed JSON in backtest results', async () => {
      const mockStrategy = {
        id: 'strategy-1',
        name: 'Test Strategy',
        type: 'mean_reversion',
        ...
        backtests: [{
          ...
          timeframe: '1h',
          config: '{}',
          results: '{invalid-json}', // Invalid JSON
          status: 'completed',
          strategyId: 'strategy-1',
          createdAt: new Date(),
          updatedAt: new Date()
    ...
    it('should handle non-string config and performance', async () => {
      const mockStrategy = {
        id: 'strategy-1',
        name: 'Test Strategy',
        type: 'mean_reversion',
        ...
        versions: [{
          ...
          name: 'Test Strategy v1',
          type: 'mean_reversion',
          config: JSON.stringify({ param1: 'value1' }), // Convert to string
          changes: 'Initial version',
          performance: JSON.stringify({ metric1: 0.5 }), // Convert to string
          backtestResults: null,
          lastTestedAt: null,
          strategyId: 'strategy-1',
          createdAt: new Date()
      ...
      expect(result.currentVersion.config).toEqual({ param1: 'value1' });
      expect(result.currentVersion.performance).toEqual({ metric1: 0.5 });
    });
  })
}) 