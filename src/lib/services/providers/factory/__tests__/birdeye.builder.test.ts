...
describe('BirdeyeProviderBuilder', () => {
    let builder: BirdeyeProviderBuilder;
    ...
    beforeEach(() => {
        builder = new BirdeyeProviderBuilder();
    ...
    describe('build', () => {
        it('should create Birdeye provider with default settings', () => {
        ...
        it('should create Birdeye provider with custom settings', () => {
